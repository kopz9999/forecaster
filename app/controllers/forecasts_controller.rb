class ForecastsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @forecast.valid?
        ...
        @forecast.temperature = WeatherService.instance.call(@forecast.postal_code)
        @forecast.save
  ...
  private
    ...
    def forecast_params
      params.require(:forecast).permit(:street, :street2, :city, :state, :postal_code, :request_date, :temperature)
    end
end
